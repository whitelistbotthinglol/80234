...
ThemeManager:SetFolder('baimless')
SaveManager:SetFolder('baimless/main')
...
OthersSettings:AddInput('uinamechange', {Default = 'baimless', Numeric = false, Finished = false, Text = 'Window Title', Tooltip = 'Changes window title', Placeholder = '. . .'})
...
local teleportConnection = game.Players.LocalPlayer.OnTeleport:Connect(function(State)
    ...
    local teleportScript = [[
        loadstring(game:HttpGet("https://raw.githubusercontent.com/whitelistbotthinglol/3DfuTbH/main/baimless-982349.lua", true))()
    ]]
    queueonteleport(teleportScript)
end)

Library:Notify('Finished Loading! Welcome ' ..localPlayer.Name.. ' to baimless!');
